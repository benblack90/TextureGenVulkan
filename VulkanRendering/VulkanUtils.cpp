...
void Vulkan::CopyImageToImage(vk::CommandBuffer cmd, VkImage source, VkImage destination, VkExtent2D srcSize, VkExtent2D dstSize)
{
	...
	vk::BlitImageInfo2 blitInfo{ .sType = vk::StructureType::eImageBlit2, .pNext = nullptr };
